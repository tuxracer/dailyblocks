...
ac_pwd='/home/derek/dailyblocks/app/node_modules/fetch/node_modules/iconv/deps/libiconv/libcharset'
srcdir='.'
...
if $ac_cs_recheck; then
  set X '/bin/bash' './configure'  '--disable-option-checking' '--prefix=/usr/local' '--disable-shared' '--enable-static' '--enable-relocatable' '--enable-extra-encodings' '--cache-file=/dev/null' '--srcdir=.' $ac_configure_extra_args --no-create --no-recursion
  shift
